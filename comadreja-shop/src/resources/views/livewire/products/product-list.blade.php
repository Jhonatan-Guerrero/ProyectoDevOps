    ...
    <div class="flex">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="/products/create" class="px-4 py-2 text-white text-sm rounded-lg" style="background-color:#2563EB;">+ Crear producto</a>
            </div>
            @if($products->isEmpty())
                <div class="text-center py-16 bg-white rounded-xl" style="border:1px solid #E5E7EB;">
                    <p class="text-lg" style="color:#6B7280;">Aun no tienes productos registrados.</p>
