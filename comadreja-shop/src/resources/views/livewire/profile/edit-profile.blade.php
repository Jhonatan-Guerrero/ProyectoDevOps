            ...
            <div class="max-w-2xl space-y-6">
                <div class="bg-white rounded-xl p-6" style="border:1px solid #E5E7EB;">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="/profile/edit" class="px-4 py-2 text-white text-sm rounded-lg" style="background-color:#2563EB;">Editar perfil</a>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold" style="background-color:#B9EBD7; color:#0F6B3A;">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="p-3 rounded-lg" style="border:1px solid #F3F4F6;">
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <span class="text-xs px-2 py-1 rounded-full" style="@if($pedido->status == 'pendiente') background-color:#FEF3C7; color:#92400E; @elseif($pedido->status == 'en_preparacion') background-color:#DBEAFE; color:#1E40AF; @elseif($pedido->status == 'enviado') background-color:#E0E7FF; color:#3730A3; @else background-color:#D1FAE5; color:#065F46; @endif">
