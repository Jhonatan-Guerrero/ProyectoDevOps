<aside class="w-52 min-h-screen pt-4 px-2" style="background-color: white; border-right: 1px solid #E5E7EB;">
    <ul class="space-y-1">
        <li>
            <a href="/vendor/dashboard" class="flex items-center gap-3 px-4 py-2 rounded-lg text-sm {{ request()->is('dashboard') ? 'font-medium' : '' }}"
                style="{{ request()->is('dashboard') ? 'background-color:#F0FAF6;' : '' }} color:#111827;">
